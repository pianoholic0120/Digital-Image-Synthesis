...
class FourChanDeepRgbaContinuous : public BaseDeepHelper<
                                       RGBA_T,
                                       FourChanDeepRgbaContinuous<RGBA_T>,
                                       SpanRgba>
{
public:
    typedef BaseDeepHelper<RGBA_T, FourChanDeepRgbaContinuous<RGBA_T>, SpanRgba>
                                               super_type;
    ...
    FourChanDeepRgbaContinuous (
        ...
        : BaseDeepHelper<RGBA_T, FourChanDeepRgbaContinuous<RGBA_T>, SpanRgba> (
...
class FourChanDeepRgbaDiscrete
    : public BaseDeepHelper<RGBA_T, FourChanDeepRgbaDiscrete<RGBA_T>, SpanRgba>
{
public:
    typedef BaseDeepHelper<RGBA_T, FourChanDeepRgbaDiscrete<RGBA_T>, SpanRgba>
                                             super_type;
    ...
    FourChanDeepRgbaDiscrete (
        DtexFile* i_dtexFile, int i_numDtexChans, const Parameters& i_params)
        : BaseDeepHelper<RGBA_T, FourChanDeepRgbaDiscrete<RGBA_T>, SpanRgba> (
              i_dtexFile, i_numDtexChans, i_params)
    {}
...
template <typename RGBA_T>
void
FourChanDeepRgbaContinuous<RGBA_T>::processDeepPixel (int i_numPts)
{
    assert (i_numPts > 0);
...
template <typename RGBA_T>
void
FourChanDeepRgbaDiscrete<RGBA_T>::processDeepPixel (int i_numPts)
{
    assert (i_numPts > 0);
    ...
    for (int j = 0; j < i_numPts; ++j)
    {
        ...
        (this->m_deepOutPixel)
            .push_back (
                spanJ.in, spanJ.rgb[0], spanJ.rgb[1], spanJ.rgb[2], alpha);
    }
}
