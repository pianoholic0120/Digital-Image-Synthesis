...
DeepTiledOutputPart::DeepTiledOutputPart (
...
IMATH_NAMESPACE::Box2i
DeepTiledOutputPart::dataWindowForTile (int dx, int dy, int l) const
{
    return file->dataWindowForTile (dx, dy, l);
}

IMATH_NAMESPACE::Box2i
DeepTiledOutputPart::dataWindowForTile (int dx, int dy, int lx, int ly) const
{
...
void
DeepTiledOutputPart::writeTiles (
...
void
DeepTiledOutputPart::writeTiles (int dx1, int dx2, int dy1, int dy2, int l)
{
