...
execute_process(COMMAND "${CMAKE_COMMAND}" -E compare_files "${OUT}" "${DATA}" RESULT_VARIABLE ret)

if (NOT ${ret} EQUAL 0)
    message(FATAL_ERROR "compare_files ${OUT} ${DATA} returned a non-zero value: ${ret}")
endif()
